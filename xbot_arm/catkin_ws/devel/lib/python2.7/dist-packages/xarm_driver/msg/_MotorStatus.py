...
"""autogenerated by genpy from xarm_driver/MotorStatus.msg. Do not edit."""
import codecs
import sys
...
class MotorStatus(genpy.Message):
  _md5sum = "b35e70483b9ebb379f12dfaee0874ca1"
  _type = "xarm_driver/MotorStatus"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """float32[] location
float32[] speed
float32[] load
float32[] voltage
float32[] temperature
...
uint8[] error
"""
  __slots__ = ['location','speed','load','voltage','temperature','current','error']
  _slot_types = ['float32[]','float32[]','float32[]','float32[]','float32[]','float32[]','uint8[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       location,speed,load,voltage,temperature,current,error
