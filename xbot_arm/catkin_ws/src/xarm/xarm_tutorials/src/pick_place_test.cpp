...
void openGripper(trajectory_msgs::JointTrajectory& posture)
{
  ...
  posture.points[0].positions[0] = 0.66;
  posture.points[0].positions[1] = 0.66;
...
void closedGripper(trajectory_msgs::JointTrajectory& posture)
{
  ...
  posture.points[0].positions[1] = 0.09;
  posture.points[0].time_from_start = ros::Duration(0.5);
  // END_SUB_TUTORIAL
}
...
void pick(moveit::planning_interface::MoveGroupInterface& move_group)
{
  ...
  grasps[0].post_grasp_retreat.desired_distance = 0.08;
...
void place(moveit::planning_interface::MoveGroupInterface& group)
{
  ...
  place_location[0].place_pose.pose.position.z = 0.88;
  ...
  place_location[0].post_place_retreat.desired_distance = 0.18;
...
void addCollisionObjects(moveit::planning_interface::PlanningSceneInterface& planning_scene_interface)
{
  ...
  collision_objects[1].primitives[0].dimensions[2] = 0.78;

  /* Define the pose of the table. */
  collision_objects[1].primitive_poses.resize(1);
  collision_objects[1].primitive_poses[0].position.x = -0.72;
  ...
  collision_objects[2].primitives[0].dimensions[2] = 0.24;
...
{
  ros::init(argc, argv, "xbot_arm_pick_place");
  ros::NodeHandle nh;
