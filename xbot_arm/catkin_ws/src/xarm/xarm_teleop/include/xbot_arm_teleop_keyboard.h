#ifndef XBOT_ARM_TELEOP_KEYBOARD_H_
#define XBOT_ARM_TELEOP_KEYBOARD_H_
...
class XbotArmTeleop
{
 ...
 public:
  ...
  void printText(moveit::planning_interface::MoveGroupInterface& arm_group);
  void setGoal(char ch,moveit::planning_interface::MoveGroupInterface& arm_group, moveit::planning_interface::MoveGroupInterface & gripper_group);
