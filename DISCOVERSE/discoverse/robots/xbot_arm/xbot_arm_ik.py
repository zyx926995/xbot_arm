...
class XbotArmIK:
    ...
    a1 = 0.14  # 从base_link到arm_1_link的距离
    a2 = -0.095  # 从arm_1_link到arm_2_link的距离
    a3 = 0.145  # 从arm_2_link到arm_3_link的距离
    a4 = -0.105  # 从arm_3_link到arm_4_link的距离
    a5 = 0.105  # 从arm_4_link到arm_5_link的距离
    a6 = -0.075  # 从arm_5_link到arm_6_link的距离
    a7 = 0.125  # 从arm_6_link到TCP的距离
    
    arm_joint_range = np.array([
        [-2.094, -1.57, -2.793, -1.92, -2.793, -1.57],
        [ 2.094,  1.57,  2.793,  1.92,  2.793,  1.57]
    ])
    ...
    def move_joint6_2_joint5(self, pos, ori):
        ret = np.array([
            -ori[0, 2] * self.a7 + pos[0],
            -ori[1, 2] * self.a7 + pos[1],
            -ori[2, 2] * self.a7 + pos[2]
        ])
        return ret