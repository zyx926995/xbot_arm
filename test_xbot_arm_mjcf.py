...
if __name__ == "__main__":  
    ...
    if mjcf_path is None:
        mjcf_path = os.path.join(os.path.dirname(__file__), "DISCOVERSE", "models", "mjcf", "xbot_arm_floor.xml")

        # mjcf_path = os.path.join(os.path.dirname(__file__), "DISCOVERSE", "models", "mjcf", "airbot_play_floor.xml")
